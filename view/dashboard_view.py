...
class DashboardView(ctk.CTkFrame):
    ...
    def show_appointments_book(self, appointment=None):
        appt_ctrl = self.parent.controller.appointment_controller
        # on récupère la méthode refresh de la liste courante
    ...
    def show_edit_appointment(self, appt_id):
        appt_ctrl = self.parent.controller.appointment_controller
        appt = appt_ctrl.repo.get_by_id(appt_id)
        edit_win = AppointmentsBook(self, controller=appt_ctrl, appointment=appt)
        edit_win.grab_set()
