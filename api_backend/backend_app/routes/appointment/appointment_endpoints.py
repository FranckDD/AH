...
from api_backend.backend_app.exceptions import translate_integrity_error  # si tu l'as
...
from api_backend.backend_app.routes.auth.auth_endpoints import get_current_user  # dépendance auth
